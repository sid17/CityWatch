<?php
	if (!empty($_POST))
	{
		...
		$height=$obj->{'height'};
		$sql = "select * from reportdata where UUID='".$zone."'  order by id desc limit 40";
...
$output.="<a href='#display_mine' style='text-decoration:none;font-size:180%;' onclick='update_mine(this)' data-status='".$info['status']."' data-time='".$info['time']."'        data-long='".$info['lang']."' data-lat='".$info['lat']."' id='".$info['id']."' >";
